package project.fathurrahman.khs.Adapter.AdapterGuru.AdapterNilaiAkhir;
...
import project.fathurrahman.khs.Guru.NilaiAkhir.NilaiAkhirEdit;
import project.fathurrahman.khs.Guru.NilaiAkhir.NilaiAkhirInput;
...
public class NilaiAkhirSiswaAdapter extends RecyclerView.Adapter<NilaiAkhirSiswaAdapter.MyViewHolder>{
    ...
    //    String url_del = "http://sdbundamulia.com/ws_khs/NilaiAkhirDelete.php";
    String url_view = "http://sdbundamulia.com/ws_khs/NilaiAkhirViewValid.php";
    ...
    @Override
    public void onBindViewHolder(final NilaiAkhirSiswaAdapter.MyViewHolder holder, final int position) {
        final NilaiAkhirSiswaModel all = NilaiAkhirSiswaModelList.get(position);
        ...
        holder.dots.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent a = new Intent(mContext, NilaiAkhirEdit.class);
                a.putExtra("nis", nis);
...
//                showPopupMenu(holder.dots);
    ...
    private View.OnClickListener onClickListener(final String idMtPljrn, final String nis, final String idThnAjaran) {
        return new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                NilaiAkhirView(idMtPljrn, nis, idThnAjaran);
            }
        };
    }
    ...
    private void NilaiAkhirView(final String idMtPljrn, final String nis, final String idThnAjaran){
            ...
            protected void onPostExecute(String s) {
                ...
                try {
                    ...
                    if(result.equals("1")){
                        ...
                        Toast.makeText(mContext, "Nilai Akhir telah dimasukan", Toast.LENGTH_LONG).show();
                    }else{
...
//
//        popup.setOnMenuItemClickListener(new NilaiAkhirSiswaAdapter.MyMenuItemClickListener());
//        popup.show();
//    }
//
...
//        NilaiAkhirSiswaModelList.remove(position);
//        notifyItemRemoved(position);
//        notifyItemRangeChanged(position, NilaiAkhirSiswaModelList.size());
//    }
//
