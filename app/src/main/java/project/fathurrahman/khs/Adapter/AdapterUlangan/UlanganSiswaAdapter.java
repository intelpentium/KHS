package project.fathurrahman.khs.Adapter.AdapterUlangan;
...
import project.fathurrahman.khs.Ulangan.UlanganInput;
...
public class UlanganSiswaAdapter extends RecyclerView.Adapter<UlanganSiswaAdapter.MyViewHolder>{
    ...
    @Override
    public void onBindViewHolder(final UlanganSiswaAdapter.MyViewHolder holder, int position) {
        UlanganSiswaModel all = UlanganSiswaModelList.get(position);
