...
import project.fathurrahman.khs.Adapter.AdapterGuru.SpinnerGuruKelas;
...
public class Raport extends AppCompatActivity {
    ...
    String getkelas, getkelasname, getsemester = "1";
    ...
    String url = "http://sdbundamulia.com/ws_khs/Raport.php";
    String url_siswa = "http://sdbundamulia.com/ws_khs/RaportSiswa.php";
...
//                        new ParsingNegara().execute();
        ...
        Button nextBtn = (Button) findViewById(R.id.simpanBtn);
        nextBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

//                Intent a = new Intent(Raport.this, RaportDetail.class);
//                startActivity(a);
                Raport();
            }
        });
    ...
    public void ListSpinner() {
        ...
        class ParsingNegara extends AsyncTask<Void, Void, String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(Raport.this, "Menampilkan Data...", "Silahkan Tunggu..." ,false, false);
            }
...
//                        mResources[it] = coun.getString("nis");
//                    }
//
//                    ArrayAdapter<String> adapter = new ArrayAdapter<String>
//                            (Raport.this,android.R.layout.select_dialog_item, mResources);
//
...
//
//                A_ParsingRequest parsing = new A_ParsingRequest();
//                String res2 = parsing.sendPostRequest(url_siswa, par2);
//                return res2;
//            }
//        }
//
...
//            startActivity(a);
            ActivityCompat.finishAfterTransition(Raport.this);
            return true;
        }
