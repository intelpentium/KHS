package project.fathurrahman.khs.Uas;
...
import project.fathurrahman.khs.Adapter.AdapterUas.UasSiswaAdapter;
import project.fathurrahman.khs.Adapter.AdapterUas.UasSiswaModel;
...
//                Toast.makeText(UasSiswa.this, ""+s2, Toast.LENGTH_SHORT).show();
                ...
                try {
                    ...
                    for(int it = 0; it < hasilArray.length(); it++){
                        ...
                        UasSiswaModel kostData = new UasSiswaModel();
                        ...
                        UasSiswaModelList.add(kostData);
                    }

                    adapter = new UasSiswaAdapter(UasSiswa.this, UasSiswaModelList);
                    recyclerView.setAdapter(adapter);
                    recyclerView.setLayoutManager(new LinearLayoutManager(UasSiswa.this));
...
//                String idGuru = prefer.getString("idGuru","Not Available" );
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            ActivityCompat.finishAfterTransition(UasSiswa.this);
            return true;
        }
