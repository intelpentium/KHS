package project.fathurrahman.khs.Ulangan;
...
import project.fathurrahman.khs.Adapter.AdapterUlangan.UlanganListAdapter;
import project.fathurrahman.khs.Adapter.AdapterUlangan.UlanganListModel;
...
public class UlanganList extends AppCompatActivity {

    private RecyclerView recyclerView;
    private UlanganListAdapter adapter;
...
//                Toast.makeText(UlanganList.this, ""+s2, Toast.LENGTH_SHORT).show();
...
//                        Toast.makeText(UlanganList.this, ""+coun.getString("idMtpljrn"), Toast.LENGTH_SHORT).show();

                        UlanganListModel kostData = new UlanganListModel();
                        ...
                        UlanganListModelList.add(kostData);
                    }

                    adapter = new UlanganListAdapter(UlanganList.this, UlanganListModelList);
                    recyclerView.setAdapter(adapter);
                    recyclerView.setLayoutManager(new LinearLayoutManager(UlanganList.this));
...
//                String idGuru = prefer.getString("idGuru","Not Available" );
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            ActivityCompat.finishAfterTransition(UlanganList.this);
            return true;
        }
