    ...
    public void ListSpinner() {
        ...
        class ParsingNegara extends AsyncTask<Void, Void, String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(Tugas.this, "Menampilkan Data...", "Silahkan Tunggu..." ,false, false);
            }
...
//                Toast.makeText(PurchaseOutlet.this, ""+s2, Toast.LENGTH_SHORT).show();
                ...
                try {
                    ...
                    if(hasil.equals("1")){
                        ...
                        // untuk mengirim data
                        Intent a = new Intent(Tugas.this, TugasList.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            ...
            Intent a = new Intent(Tugas.this, Nilai.class);
            startActivity(a);
