...
import project.fathurrahman.khs.Adapter.AdapterGuru.NilaiAdapter;
import project.fathurrahman.khs.Adapter.AdapterGuru.NilaiModel;
...
public class Nilai extends AppCompatActivity{
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            ...
            Intent a = new Intent(Nilai.this, HomeGuru.class);
            startActivity(a);
