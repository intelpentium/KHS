...
import project.fathurrahman.khs.Adapter.AdapterTugas.TugasListAdapter;
import project.fathurrahman.khs.Adapter.AdapterTugas.TugasListModel;
...
//                        Toast.makeText(TugasList.this, ""+coun.getString("idMtpljrn"), Toast.LENGTH_SHORT).show();
