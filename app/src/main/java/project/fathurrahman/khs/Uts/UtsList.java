package project.fathurrahman.khs.Uts;
...
import project.fathurrahman.khs.Adapter.AdapterUts.UtsListAdapter;
import project.fathurrahman.khs.Adapter.AdapterUts.UtsListModel;
...
public class UtsList extends AppCompatActivity {

    private RecyclerView recyclerView;
    private UtsListAdapter adapter;
...
//                Toast.makeText(UtsList.this, ""+s2, Toast.LENGTH_SHORT).show();
...
//                        Toast.makeText(UtsList.this, ""+coun.getString("idMtpljrn"), Toast.LENGTH_SHORT).show();

                        UtsListModel kostData = new UtsListModel();
                        ...
                        UtsListModelList.add(kostData);
                    }

                    adapter = new UtsListAdapter(UtsList.this, UtsListModelList);
                    recyclerView.setAdapter(adapter);
                    recyclerView.setLayoutManager(new LinearLayoutManager(UtsList.this));
...
//                String idGuru = prefer.getString("idGuru","Not Available" );
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            ActivityCompat.finishAfterTransition(UtsList.this);
            return true;
        }
