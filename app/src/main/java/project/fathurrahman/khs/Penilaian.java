...
import project.fathurrahman.khs.Adapter.PenilaianAdapter;
import project.fathurrahman.khs.Adapter.PenilaianModel;
...
public class Penilaian extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PenilaianModel kostData = new PenilaianModel("1", "Absen Siswa");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            ...
            Intent a = new Intent(Penilaian.this, Home.class);
            startActivity(a);
