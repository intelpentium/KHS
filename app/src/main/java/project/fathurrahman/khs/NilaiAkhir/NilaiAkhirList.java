package project.fathurrahman.khs.NilaiAkhir;
...
import project.fathurrahman.khs.Adapter.AdapterNilaiAkhir.NilaiAkhirListAdapter;
import project.fathurrahman.khs.Adapter.AdapterNilaiAkhir.NilaiAkhirListModel;
...
public class NilaiAkhirList extends AppCompatActivity {

    private RecyclerView recyclerView;
    private NilaiAkhirListAdapter adapter;
...
//                Toast.makeText(NilaiAkhirList.this, ""+s2, Toast.LENGTH_SHORT).show();
...
//                        Toast.makeText(NilaiAkhirList.this, ""+coun.getString("idMtpljrn"), Toast.LENGTH_SHORT).show();

                        NilaiAkhirListModel kostData = new NilaiAkhirListModel();
                        ...
                        NilaiAkhirListModelList.add(kostData);
                    }

                    adapter = new NilaiAkhirListAdapter(NilaiAkhirList.this, NilaiAkhirListModelList);
                    recyclerView.setAdapter(adapter);
                    recyclerView.setLayoutManager(new LinearLayoutManager(NilaiAkhirList.this));
...
//                String idGuru = prefer.getString("idGuru","Not Available" );
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            ActivityCompat.finishAfterTransition(NilaiAkhirList.this);
            return true;
        }
