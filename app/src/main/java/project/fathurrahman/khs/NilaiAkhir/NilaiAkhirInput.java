...
public class NilaiAkhirInput extends AppCompatActivity {
    ...
    String nilaiTugas, nilaiUlangan, nilaiUts, nilaiUas;
...
//            rata_tugas.setVisibility(View.VISIBLE);
        ...
        public void afterTextChanged(Editable s) {
            if (s.length() == 0) {
                ...
                hasil_nilai_akhir = hasilTugas + Integer.parseInt(nilaiUts)+ Integer.parseInt(nilaiUas);
...
//            rata_tugas.setVisibility(View.VISIBLE);
        ...
        public void afterTextChanged(Editable s) {
            if (s.length() == 0) {
                ...
                hasil_nilai_akhir = hasilUlangan + Integer.parseInt(nilaiUts)+ Integer.parseInt(nilaiUas);
...
//                Toast.makeText(NilaiAkhirInput.this, ""+s, Toast.LENGTH_SHORT).show();
                ...
                try {
                    ...
                    if(result.trim().equals("1")){
                        ...
                        Intent a = new Intent(NilaiAkhirInput.this, Nilai.class);
                        startActivity(a);
                        finish();
