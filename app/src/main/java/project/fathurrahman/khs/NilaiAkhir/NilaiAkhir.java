...
import project.fathurrahman.khs.Adapter.SpinnerGuruKelas;
...
public class NilaiAkhir extends AppCompatActivity {
    ...
    String url = "http://sdbundamulia.com/ws_khs/Tugas.php";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.nilai_akhir);
    ...
    public void ListSpinner() {
        ...
        class ParsingNegara extends AsyncTask<Void, Void, String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(NilaiAkhir.this, "Menampilkan Data...", "Silahkan Tunggu..." ,false, false);
            }
...
//                Toast.makeText(PurchaseOutlet.this, ""+s2, Toast.LENGTH_SHORT).show();
                ...
                try {
                    ...
                    if(hasil.equals("1")){
                        ...
                        Intent a = new Intent(NilaiAkhir.this, NilaiAkhirList.class);
//                        a.putExtra("semester", getsemester);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            ...
            Intent a = new Intent(NilaiAkhir.this, Nilai.class);
            startActivity(a);
