...
//        Calendar c1 = Calendar.getInstance();
        SimpleDateFormat sdf1 = new SimpleDateFormat("HH:mm:ss d-M-yyyy");
...
//        else if(!getAgenda.matches("[a-zA-Z_]+")){
//            Toast.makeText(Agenda.this, "Data tidak boleh angka saja", Toast.LENGTH_SHORT).show();
//        }
        else{
    ...
    private void InputAgenda(){

        class ParsingInputAgenda extends AsyncTask<Void, Void, String> {
...
//                        a.putExtra("idThnAjaran", idThnAjaran);
        ...
        ParsingInputAgenda tambah = new ParsingInputAgenda();
        tambah.execute();
