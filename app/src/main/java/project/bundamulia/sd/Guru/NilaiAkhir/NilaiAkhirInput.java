...
public class NilaiAkhirInput extends AppCompatActivity {

    String idMtPljrn, idThnAjaran, semester, nis;
    String nilaiTugas, nilaiUlangan, nilaiUts, nilaiUas, pembagiUl, pembagiTugas;
    int hasilTugas, hasilUlangan, hasil_nilai_akhir;

    TextView nilai_pembagi_tugas, nilai_pembagi_ulangan;
    TextView jml_tugas, rata_tugas, jml_ulangan, rata_ulangan, nilai_uts, nilai_uas, nilai_akhir;

    String url = "http://sdbundamulia.com/ws_khs/NilaiAkhirInput.php";
...
//        nilai_pembagi_tugas = (TextView) findViewById(R.id.nilai_pembagi_tugas);
//        nilai_pembagi_tugas.addTextChangedListener(calculation);

//        nilai_pembagi_ulangan = (TextView) findViewById(R.id.nilai_pembagi_ulangan);
    ...
    private void NilaiView(){
        ...
        class ParsingLogin extends AsyncTask<Void, Void, String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(NilaiAkhirInput.this, "Menampilkan Data...", "Silahkan Tunggu..." ,false, false);
            }
...
//                Toast.makeText(NilaiAkhirInput.this, ""+s, Toast.LENGTH_SHORT).show();
...
//                        editor.commit();
                        ...
                        Intent a = new Intent(NilaiAkhirInput.this, NilaiAkhirSiswa.class);
                        a.putExtra("nis", nis);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            ActivityCompat.finishAfterTransition(NilaiAkhirInput.this);
            return true;
        }
