...
import project.bundamulia.sd.Adapter.AdapterGuru.AdapterListSiswa.ListSiswaAdapter;
import project.bundamulia.sd.Adapter.AdapterGuru.AdapterListSiswa.ListSiswaModel;
...
//        getmapel = a.getString("idMtPljrn");
        ...
        if(status == "GURU WALI KELAS" || status.equals("GURU WALI KELAS")){
            ...
            Toast.makeText(getApplication(), "Kontak siswa tidak dibolehkan !!", Toast.LENGTH_LONG).show();
        }
...
//                        mCountryModel.add(new CountryModel(coun.getString("nama_kategori"), coun.getString("nama_nama")));
                        ...
                        kostData.images  = coun.getString("dp");
...
//            Intent a = new Intent(ListSiswa.this, HomeGuru.class);
//            startActivity(a);
//            finish();
            return true;
        }
