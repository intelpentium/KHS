package project.bundamulia.sd.Guru.ListSiswa;
...
import project.bundamulia.sd.Adapter.AdapterGuru.AdapterListSiswa.ListSiswaKelasAdapter;
import project.bundamulia.sd.Adapter.AdapterGuru.AdapterListSiswa.ListSiswaKelasModel;
import project.bundamulia.sd.Guru.HomeGuru;
...
public class ListSiswaKelas extends AppCompatActivity {

    private RecyclerView recyclerView;
    private ListSiswaKelasAdapter adapter;
    private List<ListSiswaKelasModel> ListSiswaKelasModelList;
...
//                Toast.makeText(ListSiswaKelas.this, ""+s2, Toast.LENGTH_SHORT).show();
                ListSiswaKelasModelList = new ArrayList<>();
...
//                        Toast.makeText(ListSiswaKelas.this, ""+coun.getString("idMtpljrn"), Toast.LENGTH_SHORT).show();

                        ListSiswaKelasModel kostData = new ListSiswaKelasModel();
                        ...
                        ListSiswaKelasModelList.add(kostData);
                    }

                    adapter = new ListSiswaKelasAdapter(ListSiswaKelas.this, ListSiswaKelasModelList);
                    recyclerView.setAdapter(adapter);
                    recyclerView.setLayoutManager(new LinearLayoutManager(ListSiswaKelas.this));
...
//            ActivityCompat.finishAfterTransition(ListSiswaKelas.this);

            Intent a = new Intent(ListSiswaKelas.this, HomeGuru.class);
            startActivity(a);
            finish();
            return true;
