...
import project.bundamulia.sd.Adapter.AdapterGuru.AdapterAbsen.AbsenSiswaAdapter;
...
public class AbsenSiswa extends AppCompatActivity {
    ...
    String getnis, getidMtpljrn, getidKelas, getidThnAjaran, getsemester, gettgl;
    String nis="", ket="";
...
//                Toast.makeText(AbsenSiswa.this, ""+s2, Toast.LENGTH_SHORT).show();
...
//                        editor.commit();
                        ...
                        Intent a = new Intent(AbsenSiswa.this, Absen.class);
                        startActivity(a);
                        finish();
