...
import project.bundamulia.sd.Adapter.AdapterOrtu.HomeOrtuAdapter;
...
//                    Toast.makeText(getApplication(), "Data Berhasil. Selamat !!", Toast.LENGTH_LONG).show();
    ...
    // untuk panggil data ke database secara terus menerus
    private final Runnable m_Runnable = new Runnable(){
        public void run(){

            View();

            // waktu minta data ke server (disini per 1 detik
            HomeOrtu.this.mHandler.postDelayed(m_Runnable,1000);
        }
    };

    //Method untuk proses ambil data ke database
    private void View(){
